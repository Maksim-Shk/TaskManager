...
namespace TaskManager.Persistence
{
    public class TaskManagerContext : DbContext, ITaskManagerContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            TaskAndUserGenerator taskAndUserGenerator = new();
            taskAndUserGenerator.GenerateUserAndTaskLists();


            modelBuilder.Entity<User>()
                .HasData(taskAndUserGenerator.Users);

            modelBuilder.Entity<Task>()
                .HasData(taskAndUserGenerator.Tasks);
        }
    }
}